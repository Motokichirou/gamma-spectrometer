...
2. **Разводка PCB** — 🚧 НАЧАТА (сессия 12). Все 4 платы в одном `gamma_spectrometer.kicad_pcb` (KiCad 9, 4 слоя). USB/Power: контур Ø45, обвязка USB-C, узлы FT231X/AMS1117, земля залита+сшита, питание частично. Межплатка: цанговые гнёзда (сигнал/питание) + латунные стойки (GND/корпус/крепёж) — ещё не в схеме. Детали и статус — `docs/session_context.md` (блок «РАЗВОДКА PCB»).
