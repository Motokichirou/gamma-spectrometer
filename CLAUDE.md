...
7. **⚠ ПРИНЯТО, НЕ РАЗВЕДЕНО (вход делителя):** AD8000 → **ADA4817-1ARDZ как TIA** — решение 2026-06-21 (дешевле вдвое, −18% шума, идеальная линейность; drop-in: корпус RD-8-4 и распиновка = AD8000). Подтверждено `simulation/sim_tia_real.cir` + `sim_tia_stab.cir` (Cf=4.7пФ, 0дБ пик, BW 92МГц). **В схеме/нетлисте/BOM ПОКА AD8000** — переразводка/перемаркировка запланированы. Remove/add — в `divider_board.md`.
