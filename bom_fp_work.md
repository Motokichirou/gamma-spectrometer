...
> **Статус:** ВСЕ КОМПОНЕНТЫ НАЗНАЧЕНЫ ✅ (включая J_PMT401 — футпринт `J_PMT401_R1307-01` сделан, Ø30)
> Свежий нетлист: `pcb/gamma_spectrometer.net` (2026-06-24, 177 компонентов: 74 конд. + 63 рез. + активные/прочие)
> ⚠ **Правки 2026-08-07 ещё НЕ в нетлисте** (схему правит пользователь): R313 2к→14.7к, R311 5.9к→909,
> U301 TL431→REF35250 (SOT-23-6), R301 удалён, C303 100нФ→1мкФ, добавлен C322 1мкФ.
> После правки схемы: 75 конденсаторов, 62 резистора, всего 177.
...
### Конденсаторы — 17 уникальных MPN, 74 шт

| Refs | Qty | Value | MPN | Footprint |
|---|---|---|---|---|
| C13a201, C13b201, C14a201, C14b201, C15a201, C15b201, C16a201, C16b201, C17a201, C17b201, C410 | 11 | 0.1uF / 1кВ | C1812X104K102T (Holy Stone) | C_1812_HandSolder |
...
| C102, C107-C111, C114, C116, C203, C204, C207, C217, C304-C309, C311-C314, C317, C319-C321, C412, C414 | 28 | 0.1uF X7R | CC0603JRX7R9BB104 (Yageo) | C_0603_HandSolder |
| C103, **C303**, **C322** | 3 | 1uF X7R | CC0805JKX7R9BB105 (Yageo) | C_0805_HandSolder — C303 выход REF35250 (обязателен 0.1…10 мкФ), C322 на вывод NR |
...
| ~~R301~~ | — | ~~330R~~ | — | **УДАЛЁН 2026-08-07**: балласт шунта TL431 не нужен последовательной опоре REF35250 |
| R306, R308 | 2 | 1k | RC0603FR-071KL | Yageo RC |
| R310 | 1 | 22k | RC0603FR-0722KL | Yageo RC |
| R311 | 1 | **909R** | RC0603FR-07909RL | Yageo RC (было 5.9k; смена полярности 2026-08-07) |
| R312 | 1 | 8.2k | RC0603FR-078K2L | Yageo RC |
| R313 | 1 | **14.7k** | RC0603FR-0714K7L | Yageo RC (было 2k; смена полярности 2026-08-07) |
...
| U202 | 1 | TL431 | TL431 (YOUTAI) | SOT-23 |
| **U301** | 1 | **REF35250** | **REF35250QDBVR** (TI) | **SOT-23-6 (DBV)** — опора 2.5 В, 12 ppm/°C |
...
2. **U301 заменён на REF35250QDBVR** (2026-08-07, по ревью): параметрический шунт TL431 → последовательная опора,
   12 ppm/°C вместо 50 (у клона YOUTAI до 300). Дрейф калибровки на ±30 °C: 0.9 % → **0.036 %**. Критично потому,
   что эта опора задаёт и шкалу АЦП (`VREF+`), и рабочие точки шейпера (делители A/B).
   **U202 на ВВ-плате остаётся TL431** — он питает только делитель мониторинга ВВ, в энергошкале не участвует.
...
2. **Разводка PCB** (по порядку):
   ...
   2. Divider board — Ø42-45мм, footprint ФЭУ `J_PMT401_R1307-01` готов (Ø30)
...
- **Уникальных MPN:** 60+
- **Конденсаторов:** 74 → **75** после добавления C322 (17 MPN)
- **Резисторов:** 63 → **62** после удаления R301 (28 MPN: 21 серии 0603 + 7 серий 1206)
