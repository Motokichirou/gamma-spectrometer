...
### Git
HEAD после сессии 10 = `9419235` (запушено: калибровка BecqMoni + доки, без `-dbg`). Сессия 11 (совместимость AtomSpectra): правки `app.c` (обе копии) + доки — собрано, прошито, **коммитится сейчас**.
