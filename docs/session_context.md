...
> Обновлять перед каждым сжатием. Дата последнего обновления: 2026-06-16 (сессия 13 — ревью аналога + футпринты).

---

## 🟢 ТЕКУЩИЙ ФРОНТ (сессия 13, 2026-06-16): футпринты для разводки

Вернулись к разводке PCB. Делаем **3 футпринта**. Память: `project_interboard_connector`,
`feedback_kicad_ui_russian`, `feedback_kicad_approach` (схемы/.kicad_sch рисует пользователь;
**футпринты память НЕ запрещает генерировать** — предложил сгенерить .kicad_mod, жду «ок»).

| Футпринт | Отверстие | Площадка | Статус |
|---|---|---|---|
| Переходные пины (цанги) | Ø1.5 | Ø2.5 круг | спека готова |
| Стойки M2.5 (GND-бонд) | Ø2.75 | Ø~5 круг, на GND, медь сверх+низ | спека готова |
| ФЭУ J_PMT401 (R1307-**01**) | Ø1.2 (вывод 1.0) | Ø2.0 круг | **ждёт обмера пользователя** |

**ФЭУ:** версия **R1307-01** — гибкие выводы Ø1.0мм, БЕЗ цоколя (не панелька E678-14A!).
11 падов по кругу **B14-38** (14 позиций × 25.71°), круг ≈**Ø19.8мм**, нет позиций 3/9/10.
Нумерация падов = логич. пины J_PMT401: 1=K@поз14, 2=G@поз13, 3=Dy1@поз1, 4=Dy2@поз2,
5=Dy3@поз12, 6=Dy4@поз4, 7=Dy5@поз5, 8=Dy6@поз6, 9=Dy7@поз7, 10=Dy8@поз8, 11=P@поз11.
⚠ **Пользователь обмеряет ФЭУ** перед финалом: (1) реальный Ø окружности выводов, (2) Ø вывода,
(3) ориентир «верха» (чтобы не зеркалить). Даташит Ø19.8/Ø1.0 — номинал-старт. Даташит: `docs/refs/R1307_TPMH1214E.pdf` Fig.6.
