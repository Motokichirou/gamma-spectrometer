...
> 📚 **Документация:** [обзор аппаратной части](docs/ru/hardware.md) · [прошивка](docs/ru/firmware.md) · [протокол shproto](docs/ru/protocol.md) · [ПО на PC](host/README.md) · [симуляции](docs/ru/simulations.md)
...
| Прошивка STM32 | 🚧 Этапы 1–2 + самотест + энергокалибровка во flash работают на Nucleo (shproto, реальная гистограмма); этап 3 — на боевой плате |
| ПО на PC `gammapult` | 🚧 Связь, диагностика, живой спектр, мастер энергокалибровки (GUI + CLI, единый .exe); калибровка совместима с кнопками BecqMoni |
...
├── host/                             # ПО на PC `gammapult` (Win32/ImGui, GUI + CLI)
├── pcb/
